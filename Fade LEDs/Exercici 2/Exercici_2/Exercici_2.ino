...
void loop()
{
  ...
  analogWrite(led5, 80);     // posar PWM del pin 11 a 60
  ...
  analogWrite(led5, 15);    // posar PWM del pin 11 a 125
  ...
  analogWrite(led3, 80);    // posar PWM del pin 9 a 255
  analogWrite(led4, 15);    // posar PWM del pin 10 a 255
  ...
  analogWrite(led3, 15);    // posar PWM del pin 9 a 125
  ...
  analogWrite(led1, 80);     // posar PWM del pin 5 a 60
  ...
  analogWrite(led0, 80);     // posar PWM del pin 3 a 60
  ...
  delay(velocitat);          // es queden leds velocitat ms en aquest estat
    ...
    analogWrite(led0, 0);     // posar PWM del pin 3 a 60
  analogWrite(led1, 15);     // posar PWM del pin 5 a 60
  analogWrite(led2, 80);     // posar PWM del pin 6 a 60
  ...
  analogWrite(led1, 0);     // posar PWM del pin 5 a 60
  analogWrite(led2, 15);     // posar PWM del pin 6 a 60
  analogWrite(led3, 80);     // posar PWM del pin 9 a 60
  analogWrite(led4, 255);     // posar PWM del pin 10 a 60
  analogWrite(led5, 0);     // posar PWM del pin 11 a 60
  ...
  analogWrite(led4, 80);     // posar PWM del pin 10 a 60
